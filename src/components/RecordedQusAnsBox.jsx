...
const RecordedQusAnsBox = () => {
  ...
  useEffect(() => {
    if(totalRI?.totalQusAns){
    setKeys(Object.keys(totalRI?.totalQusAns).sort());
    }
  }, [totalRI?.totalQusAns]);
  useEffect(() => {
    if (currentQusKey !== "") {
      setCurrentQusAns(totalRI?.totalQusAns[currentQusKey]);
      console.log(
        "key: ",
        currentQusKey,
        " QusAns: ",
        totalRI?.totalQusAns[currentQusKey]
      );
    } else {
      setCurrentQusAns({});
    }
...
export default RecordedQusAnsBox;

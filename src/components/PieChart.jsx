...
export default function PieChart() {
  ...
  useEffect(()=>{
    ...
    setExpressions(totalExpressions[approxCurrentTime]?.allExpressions);
    let vtKeys = Object.keys(voiceTone).sort().reverse();
    let approxVTCurrentTime = vtKeys.find((x)=> x.localeCompare(currentTime)<=0);
    setCurrentVT(voiceTone[approxVTCurrentTime]?.wholeVT);
    } 
  },[currentTime]);
  return (
    <div
